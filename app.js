...
class App extends Component {
  constructor(props){
    ...
    this.handleToggleEdditing = this.handleToggleEdditing.bind(this);
  ...
  handleToggleEdditing(key, editing){
    const newItems = this.state.items.map((item) => {
      if(item.key !== key) return item;
      return {
        ...item,
            ...
            renderRow={({key, ...value}) => {
             return (
              <Row 
                ...
                onToggleEdit={(editing) => this.handleToggleEdditing(key, editing)}
                {...value}
              />
             ) 
            }}
            renderSeparator={(sectionID, rowId) => {
              return <View key={sectionID} style={styles.separator} />
            }}
          />
        </View>
        <Footer
